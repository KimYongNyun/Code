...
public class MergeSort {
    ...
    public ArrayList<Integer> mergeFunc(ArrayList<Integer> leftList, ArrayList<Integer> rightList){
        ArrayList<Integer> meregedList = new ArrayList<Integer>();
        Integer leftPoint = 0;
        ...
        while(leftList.size() > leftPoint && rightList.size() > rightPoint)
        {
            ...
            {
                meregedList.add(rightList.get(rightPoint));
                rightPoint +=1;
            }else
            {
                meregedList.add(rightList.get(leftPoint));
                leftPoint +=1;
            }
        }
        ...
        while (leftList.size() > leftPoint) {
            meregedList.add(leftList.get(leftPoint));
            leftPoint += 1;
        }
